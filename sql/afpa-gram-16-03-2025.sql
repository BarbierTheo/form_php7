...
--
-- Hôte : localhost:3306
-- Généré le : dim. 16 mars 2025 à 21:57
...
--
CREATE DATABASE IF NOT EXISTS `afpa-gram` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `afpa-gram`;
...
CREATE TABLE `76_comments` (
  ...
  `com_timestamp` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
(21, 'test', '1742073660', 2, 17),
(22, 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', '1742073695', 2, 17),
(23, 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', '1742073739', 2, 17),
(24, 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', '1742073747', 2, 17),
(25, 'ohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohuohu', '1742073798', 2, 17),
(26, 'test', '1742149503', 2, 16),
(27, 'aaaa', '1742162027', 7, 16);
...
CREATE TABLE `76_users` (
  ...
  `user_description` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `76_users` (`user_id`, `user_gender`, `user_lastname`, `user_firstname`, `user_pseudo`, `user_avatar`, `user_description`, `user_birthdate`, `user_mail`, `user_password`, `user_activated`) VALUES
(8, 'NaN', 'Azerty', 'Azerto', 'Azertz', 'avatar.png', NULL, '1995-12-14', 'azertio@gmail.com', '$2y$10$7K.8N4nvgv6loPY6J7ilZ.k9Y7Cp5Ap2c2lxIn.muhbiPRPiEsnBy', 1),
(11, 'homme', 'Admin', 'Admin', 'Admin', 'avatar.png', NULL, '2007-01-01', 'admin@admin.admin', '$2y$10$Mmm1MyiG8JV1JGzxd0mqd.TzEkERouUZVFOsKPPu/pzyibGCi7pnS', 1),
(15, 'homme', 'Barbier', 'Theo', 'blake', 'avatar.png', NULL, '1998-07-24', 'blake@mail.com', '$2y$10$DjeZdhBPUV4g4O2De9DaHuk0M0U1TwEDb8pqptSuXFYOcqx5uuguW', 1),
(16, 'homme', 'Henry', 'Thierry', 'Titi76', 'avatar.png', NULL, '1992-07-12', 'thierryhenry@mail.com', '$2y$10$Je0ljifaV29hHmljuvM8L.P78Gd4ZPs4BuYnrbMcPasryArEM3YTa', 1),
(17, 'homme', 'Decerf', 'Stéphane', 'Stan', 'avatar.png', 'test', '1987-02-06', 'standecerf@mail.com', '$2y$10$cu0DNF2d8a/FjbYdi4dynerbRqqCAPjmJNjmBh3tMQhAXsSLY..2u', 1),
(18, 'homme', 'ichem', 'dev', 'ichdev', 'avatar.png', NULL, '1999-03-02', 'ichdev@mail.com', '$2y$10$i2nCWLSWDbeO8YYxN29XDOS4.aCsfVXbw6xGQrKPwQmUs.4JBc44e', 1);
...
--
ALTER TABLE `76_comments`
  MODIFY `com_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
