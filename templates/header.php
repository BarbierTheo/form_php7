<header class="w-screen fixed flex md:flex-row flex-col justify-center items-center lg:justify-between my-4 px-8 gap-2">
    ...
    <div>
        <a class="btn btn-primary" href="<?= $_SERVER['HTTP_REFERER'] ?? "" ?>"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#84ad21" class="size-6">
