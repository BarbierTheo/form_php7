        ...
        <div class="flex gap-4 items-center">
            <div class="flex gap-1 items-center">
                <div class="flex gap-1 items-center">
                    ...
                    <span class="font-semibold"><?= (showLikes($postToDelete['post_id'], $pdo))['likes'] ?> likes</span>
                </div>
            </div>
            ...
            <div class="flex gap-1 items-center">
                ...
                <span class="font-semibold"><?= (showComments($postToDelete['post_id'], $pdo))['comments'] ?> commentaires</span>
            </div>
        </div>
