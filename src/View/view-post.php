        ...
        <div class="px-3 flex flex-col gap-2 mt-2">
            <div class="flex gap-4 items-center">
                <div class="flex gap-1 items-center cursor-pointer hover:underline">
                    <?php if (Likes::alreadyLiked($uniquePost['post_id'])) { ?>
                        <button class="flex gap-1 items-center cursor-pointer hover:underline" data-postlike="<?= $uniquePost['post_id'] ?>">
                    ...
                    <?php } ?>
                    <span class="font-semibold" id="likespost<?= $uniquePost['post_id'] ?>"><?= Likes::showLikes($uniquePost['post_id'])['likes'] ?></span>
                    </button>
                ...
                <button class="flex gap-1 items-center cursor-pointer hover:underline">
                    ...
                    <span class="font-semibold"><?= Comments::showComments($uniquePost['post_id'])['comments'] ?> commentaires</span>
                </button>
            </div>
            ...
            <div class="flex flex-col items-start gap-1">
                <?php foreach (Comments::showAllComments($uniquePost['post_id']) as $value) { ?>
    ...
    <div class="modal" role="dialog">
        <div class="modal-box">
            ...
            <div class="flex flex-col mt-4 gap-4">
                ...
                <?php
                if (count(Likes::showAllLikes($uniquePost['post_id'])) >= 1) {
                    foreach (Likes::showAllLikes($uniquePost['post_id']) as $value) { ?>
